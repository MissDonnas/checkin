...
const studentRoster = [
    { id: "adamsi", name: "Isaac Adams", type: "full", days: ["Monday", "Tuesday", "Wednesday", "Thursday"], weeks: [1, 2, 3, 5, 6] },
    ...
    { id: "belaenz", name: "Ziana Belaen", type: "full", days: ["Tuesday", "Wednesday", "Thursday", "Friday"], weeks: [1, 2, 3, 4, 5, 6] },
    { id: "bigelowca", name: "Callum Bigelow", type: "short", days: ["Tuesday", "Wednesday", "Thursday"], weeks: [3, 5] },
    { id: "bigelowch", name: "Charlotte Bigelow", type: "short", days: ["Tuesday", "Thursday"], weeks: [3, 5] },
    { id: "blaggo", name: "Oliver Blagg", type: "short", days: ["Monday", "Tuesday", "Wednesday", "Thursday"], weeks: [3, 4] },
    ...
    { id: "maruccic", name: "Casper Marucci", type: "full", days: ["Monday", "Tuesday", "Wednesday", "Thursday"], weeks: [1, 2] },
    ...
    { id: "patela", name: "Alya Patel", type: "short", days: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"], weeks: [2, 3, 4, 5, 6] },
    ...
    { id: "pricez", name: "Zola Price", type: "short", days: ["Monday", "Tuesday", "Wednesday"], weeks: [3, 4, 5, 6] },
    { id: "riddler", name: "Remington Riddle", type: "short", days: ["Monday", "Tuesday", "Wednesday"], weeks: [3] },
    { id: "rioa", name: "Adelina Rio", type: "short", days: ["Tuesday", "Wednesday", "Thursday"], weeks: [1, 2, 3, 4, 5, 6] },
    { id: "rhodesl", name: "Lincoln Rhodes", type: "short", days: ["Monday", "Tuesday", "Wednesday", "Thursday"], weeks: [3, 6] },
    { id: "ruffinl", name: "Lennon Ruffin", type: "short", days: ["Monday", "Tuesday", "Wednesday", "Thursday"], weeks: [1, 6] },
    { id: "sarveshm", name: "Meera Sarvesh", type: "short", days: ["Tuesday", "Wednesday", "Thursday"], weeks: [1, 2, 3, 4, 5, 6] },
    { id: "schwitzero", name: "Oak Schwitzer", type: "short", days: ["Tuesday", "Wednesday", "Thursday"], weeks: [1, 4, 5, 6] },
    ...
    { id: "thompsonb", name: "Benjamin Thompson", type: "short", days: ["Monday", "Tuesday", "Wednesday", "Thursday"], weeks: [1, 2, 3, 4, 5, 6] },
    { id: "vaghelaza", name: "Avi Vaghelaz", type: "full", days: ["Wednesday", "Thursday"], weeks: [1, 2, 3, 4, 5, 6] },
